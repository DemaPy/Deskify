...
export const Description = ({ data }: TDescription) => {
      ...
      <div className="w-full">
        ...
        {isEditing ? (
          ...
          <div
            ...
            role="button"
            className="min-h-20 bg-neutral-200 text-sm font-medium py-3 px-3 rounded-md"
          >
  ...
  return (
    <div className="flex items-start gap-x-3 w-full">
      ...
      <div className="w-full">
        ...
        <Skeleton className="h-20 mb-2 w-full bg-neutral-200" />
      </div>
    </div>
  );
};
